...
type UpdatableBookFields = Omit<Book, 'id' | 'created_at' | 'user_id'>;
...
export class UserState {
	...
	getHighestRatedBooks() {
		return this.allBooks
			...
			.toSorted((a, z) => z.rating! - a.rating!) // descending order
			.slice(0, 9);
	}
...
// Unique symbol for context to access single class instance,
// passing this into the context api makes the state class a singleton
